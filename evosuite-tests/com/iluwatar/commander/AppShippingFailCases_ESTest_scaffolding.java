...
public class AppShippingFailCases_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.iluwatar.commander.AppShippingFailCases"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AppShippingFailCases_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.iluwatar.commander.exceptions.ItemUnavailableException",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AppShippingFailCases_ESTest_scaffolding.class.getClassLoader()); 
