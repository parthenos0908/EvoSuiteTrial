...
public class Master_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.iluwatar.masterworker.system.systemmaster.Master"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Master_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.iluwatar.masterworker.Input", false, Master_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.iluwatar.masterworker.Result", false, Master_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Master_ESTest_scaffolding.class.getClassLoader()); 
